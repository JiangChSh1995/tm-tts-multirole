// ==UserScript==
// @name         多角色TTS播放器正式版1.0
// @namespace    http://tampermonkey.net/
// @version      1.0
// @description  网页通用TTS播放器，集成GAL游戏流式语音引擎，支持多角色与情绪自动识别、自定义API连接、自动播放及移动端UI适配。（GAL模式与多角色情感思路致谢：类脑社区 cnfh1746_06138 & kikukiku0662）
...
// @updateURL    https://raw.githubusercontent.com/JiangChSh1995/tm-tts-multirole/refs/heads/main/%E5%A4%9A%E8%A7%92%E8%89%B2TTS%E6%92%AD%E6%94%BE%E5%99%A8%E6%AD%A3%E5%BC%8F%E7%89%881.0.user.js
// @downloadURL  https://raw.githubusercontent.com/JiangChSh1995/tm-tts-multirole/refs/heads/main/%E5%A4%9A%E8%A7%92%E8%89%B2TTS%E6%92%AD%E6%94%BE%E5%99%A8%E6%AD%A3%E5%BC%8F%E7%89%881.0.user.js
// ==/UserScript==
...
(function() {
        ...
        content.innerHTML = `
            ...
            <div class="tts-modal-body">
                ...
                <div class="tts-setting-section">
                    ...
                    <div class="tts-group-controls" style="display: flex; align-items: center; gap: 8px;">
                        <input type="text" id="new-group-name" placeholder="角色名称" style="width: 170px; height: 36px; padding: 0 5px; box-sizing: border-box; margin: 0;">
                        <input type="color" id="new-group-color" value="#667eea" style="width: 40px; height: 36px; padding: 2px; border: 1px solid #ced4da; border-radius: 6px; box-sizing: border-box; cursor: pointer; margin: 0;">
                        <button id="add-group-btn" class="tts-add-group-btn" style="height: 36px; margin: 0; padding: 0 10px; display: inline-flex; align-items: center; justify-content: center; box-sizing: border-box; white-space: nowrap;">创建</button>
                    </div>
    ...
    GM_addStyle(`
        ...
        div.tts-modal .tts-group-controls {
            display: flex !important; align-items: center !important; gap: 10px !important; width: 100%;
        }
        div.tts-modal #new-group-name { width: auto !important; flex: 1 !important; margin: 0 !important; }
        ...
        div.tts-modal .tts-switch-label { display: flex; align-items: center; justify-content: space-between; width: 100%; margin: 0; cursor: pointer; }
        div.tts-modal .tts-switch-slider { position: relative; width: 40px; height: 20px; background: #ccc; border-radius: 20px; transition: .3s; }
        div.tts-modal .tts-switch-slider:before { content: ""; position: absolute; height: 16px; width: 16px; left: 2px; bottom: 2px; background: white; border-radius: 50%; transition: .3s; }
    ...
    function init() {
        ...
        createUI();
        observeChat();
        console.log("多角色TTS播放器正式版1.0 Loaded");
    }
